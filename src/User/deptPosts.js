...
function DeptPosts() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="h-[3rem] bg-yellow-400 flex justify-between items-center font-poppins">
        <p className="font-poppins font-[800] pl-4 text-white">Hello {userData && (userData?.username || "User")}</p>
      ...
      {userData ? (
        <div className="flex flex-col sm:flex-row h-full gap-4 mt-4">
